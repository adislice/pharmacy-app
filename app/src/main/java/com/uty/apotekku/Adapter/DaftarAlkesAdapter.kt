...
open class DaftarAlkesAdapter(private val list: ArrayList<DaftarAlkesDataModel>, open var limit: Int = 0, open var id_user: Int): RecyclerView.Adapter<DaftarAlkesAdapter.Holder>() {
